		...
		generateSimpleCart = function (space) {
			...
			cartColumnViews = {
				...
				decrement: function (item, column) {
					return "<div class='" + namespace + "_decrement' ui icon button'><i class='minus sign icon'></i></div>";
				},

				increment: function (item, column) {
					return "<div class='" + namespace + "_increment' ui icon button'><i class='add sign icon'></i></div>";
				},
			...
			simpleCart.extend({
				...
				writeCart: function (selector) {
					...
					cart_container.attr("class","spaced-table")
